...
class QuizServiceTest {
    ...
    void saveQuiz () throws Exception {
        ...
        Assertions.assertEquals(request.getAnswer(),quizRepository.findAll().get(0).getAnswer());
    ...
    void GetQuizById() throws Exception {
        ...
        Assertions.assertEquals("검색, 정렬시 Tuple을 구분할 수 있는 기준이 되는 Attribute" , response.getAnswer());
    ...
    void GetQuizList () throws Exception {
        ...
        Assertions.assertEquals(12,reponseList.get(0).getId());
    ...
    void modifyQuizTest () throws Exception {
        ...
        Assertions.assertEquals("인덱스 설명" , quiz.getAnswer());
